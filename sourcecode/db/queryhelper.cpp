...
static QMap<int, std::function<void(DBManager *db, const QString &, int, const QVariantMap &)>> USERDEFINED_FILTER;

QueryHelper::QueryHelper()
{
}

DBManager *QueryHelper::filter(DBManager *db, const QVariantMap &data, const QMap<QString, QString> &fieldMap)
{
...
DBManager *QueryHelper::sort(DBManager *db, const QVariantMap &data)
{
...
DBManager *QueryHelper::limitOffset(DBManager *db, const QVariantMap &data)
{
...
void QueryHelper::installUserDefinedFilter(int type, std::function<void(DBManager *db, const QString &, int, const QVariantMap &)> func)
{
